...
from mnemo_agent.workflows.orchestrator.orchestrator import Orchestrator
from mnemo_agent.workflows.parallel.parallel_llm import ParallelLLM
from mnemo_agent.workflows.router.router_llm import LLMRouter

server = Server("mnemo_agent")

app = MCPApp(name="mnemo_mcp_agent")
