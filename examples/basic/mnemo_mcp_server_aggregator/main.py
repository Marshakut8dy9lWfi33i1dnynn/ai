...
from mnemo_agent.mcp.mcp_aggregator import MCPAggregator
from rich import print

app = MCPApp(name="mnemo_mcp_agent_aggregator")


async def example_usage_persistent():
    context = app.context

    logger = get_logger("mnemo_mcp_agent_aggregator.example_usage_persistent")
...
async def example_usage():
    logger = get_logger("mnemo_mcp_agent_aggregator.example_usage")
