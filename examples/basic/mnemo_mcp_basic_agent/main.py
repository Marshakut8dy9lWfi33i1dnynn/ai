...
from mnemo_agent.config import (
    Settings,
    LoggerSettings,
    MCPSettings,
    MCPServerSettings,
...
from mnemo_agent.workflows.llm.augmented_llm import RequestParams
from mnemo_agent.workflows.llm.llm_selector import ModelPreferences
from mnemo_agent.workflows.llm.augmented_llm_anthropic import AnthropicAugmentedLLM
...
# or loaded from mnemo_agent.config.yaml/mnemo_agent.secrets.yaml
    ...
    async with app.run() as agent_app:
        ...
        async with finder_agent:
            ...
            result = await llm.generate_str(
                message="Print the contents of mnemo_agent.config.yaml verbatim",
            )
            logger.info(f"mnemo_agent.config.yaml contents: {result}")
