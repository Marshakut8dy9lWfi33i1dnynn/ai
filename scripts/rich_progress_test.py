...
import asyncio
import random
from mnemo_agent.logging.events import Event
from mnemo_agent.logging.listeners import ProgressListener
...
async def generate_test_events():
    ...
    for mcp_name in mcp_names:
        ...
        for turn in range(1, 4):
            ...
            # Start chat turn
            yield Event(
                namespace="mnemo_agent.workflow.llm.augmented_llm_openai.myagent",
                type="info",
