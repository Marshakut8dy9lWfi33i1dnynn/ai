...
from mnemo_agent.workflows.embedding.embedding_base import (
    EmbeddingModel,
    FloatArray,
    compute_similarity_scores,
    compute_confidence,
)
from mnemo_agent.workflows.router.router_base import (
    Router,
    RouterCategory,
    RouterResult,
)
...
class EmbeddingRouter(Router):
    ...
    Example usage:
        ...
        router = EmbeddingRouter(
            ...
            mnemo_mcp_agents_names=["customer_service", "tech_support"],
        )
