...
async def test_websocket_client():
    ...
    with patch("mnemo_agent.mcp.websocket.ws_connect", new=mock_ws_connect):
...
async def test_websocket_client_with_headers():
    ...
    with patch(
        "mnemo_agent.mcp.websocket.ws_connect", side_effect=mock_ws_connect
    ) as mock_connect:
...
async def test_transport_factory_websocket():
    ...
    with patch(
        "mnemo_agent.mcp.mcp_connection_manager.websocket_client"
    ) as mock_websocket:
